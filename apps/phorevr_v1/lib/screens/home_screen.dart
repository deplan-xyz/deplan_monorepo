...
import 'package:phorevr_v1/screens/account/account_settings_screen.dart';
import 'package:phorevr_v1/screens/image_viewer/image_viewer_screen.dart';
import 'package:phorevr_v1/screens/upload/images_upload_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> fetchFilesData(List<FileInfo> files) async {
    for (var i = 0; i < files.length; i++) {
      Uint8List? data;
      try {
        data = await IpfsUtils.fetch(files[i].smallPath);
                ...
                return SliverGrid(
                  ...
                  delegate: SliverChildBuilderDelegate(
                    ...
                    (context, index) {
                      ...
                      final txnHash = files[index].txnHash ?? '';
                      return Hero(
                        tag: txnHash,
