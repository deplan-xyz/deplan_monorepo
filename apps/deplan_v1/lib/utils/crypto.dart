...
class CryptoUtils {
  ...
  static String getSecretCodeV2(String entropy) {
    final entropyBase64 = base64Encode(utf8.encode(entropy));
    final secretCodeRaw = '$entropyBase64:v2';
    final secretCodeBase58 = base58encode(utf8.encode(secretCodeRaw));
    return secretCodeBase58;
  }

  static String secretCodeToEntropy(String code) {
    String entropy = code;
    try {
      final secretCodeRaw = utf8.decode(base58decode(code));
      final parts = secretCodeRaw.split(':');
      if (parts.length == 2 && parts[1] == 'v2') {
        entropy = utf8.decode(base64Decode(parts[0]));
      }
