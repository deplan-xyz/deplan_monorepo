...
Message: ${n}. 
`+i+o;break;default:h=`Unknown action '${(f=>f)(t)}'`}super(h),this.signature=void 0,this.transactionMessage=void 0,this.transactionLogs=void 0,this.signature=e,this.transactionMessage=n,this.transactionLogs=s||void 0}get transactionError(){return{message:this.transactionMessage,logs:Array.isArray(this.transactionLogs)?this.transactionLogs:void 0}}get logs(){let t=this.transactionLogs;if(!(t!=null&&typeof t=="object"&&"then"in t))return t}async getLogs(t){return Array.isArray(this.transactionLogs)||(this.transactionLogs=new Promise((e,n)=>{t.getTransaction(this.signature).then(s=>{if(s&&s.meta&&s.meta.logMessages){let i=s.meta.logMessages;this.transactionLogs=i,e(i)}else n(new Error("Log messages not found"))}).catch(n)})),await this.transactionLogs}};async function vf(r,t,e,n){let s=n&&{skipPreflight:n.skipPreflight,preflightCommitment:n.preflightCommitment||n.commitment,maxRetries:n.maxRetries,minContextSlot:n.minContextSlot},i=await r.sendTransaction(t,e,s),o;if(t.recentBlockhash!=null&&t.lastValidBlockHeight!=null)o=(await r.confirmTransaction({abortSignal:n?.abortSignal,signature:i,blockhash:t.recentBlockhash,lastValidBlockHeight:t.lastValidBlockHeight},n&&n.commitment)).value;else if(t.minNonceContextSlot!=null&&t.nonceInfo!=null){let{nonceInstruction:h}=t.nonceInfo,f=h.keys[0].pubkey;o=(await r.confirmTransaction({abortSignal:n?.abortSignal,minContextSlot:t.minNonceContextSlot,nonceAccountPubkey:f,nonceValue:t.nonceInfo.nonce,signature:i},n&&n.commitment)).value}else n?.abortSignal!=null&&console.warn("sendAndConfirmTransaction(): A transaction with a deprecated confirmation strategy was supplied along with an `abortSignal`. Only transactions having `lastValidBlockHeight` or a combination of `nonceInfo` and `minNonceContextSlot` are abortable."),o=(await r.confirmTransaction(i,n&&n.commitment)).value;if(o.err)throw i!=null?new Ua({action:"send",signature:i,transactionMessage:`Status: (${JSON.stringify(o)})`}):new Error(`Transaction ${i} failed (${JSON.stringify(o)})`);return i}function _0(r){return new Promise(t=>setTimeout(t,r))}function at(r,t){let e=r.layout.span>=0?r.layout.span:Mf(r,t),n=Q.Buffer.alloc(e),s=Object.assign({instruction:r.index},t);return r.layout.encode(s,n),n}var A0=v.nu64("lamportsPerSignature"),L0=v.struct([v.u32("version"),v.u32("state"),ot("authorizedPubkey"),ot("nonce"),v.struct([A0],"feeCalculator")]),kf=L0.span;var R0=r=>{let t=r.decode.bind(r),e=r.encode.bind(r);return{decode:t,encode:e}},T0=r=>t=>{let e=(0,Rf.blob)(r,t),{encode:n,decode:s}=R0(e),i=e;return i.decode=(o,h)=>{let f=s(o,h);return(0,cs.toBigIntLE)(Q.Buffer.from(f))},i.encode=(o,h,f)=>{let b=(0,cs.toBufferLE)(o,r);return n(b,h,f)},i},In=T0(8);var De=Object.freeze({Create:{index:0,layout:v.struct([v.u32("instruction"),v.ns64("lamports"),v.ns64("space"),ot("programId")])},Assign:{index:1,layout:v.struct([v.u32("instruction"),ot("programId")])},Transfer:{index:2,layout:v.struct([v.u32("instruction"),In("lamports")])},CreateWithSeed:{index:3,layout:v.struct([v.u32("instruction"),ot("base"),Bn("seed"),v.ns64("lamports"),v.ns64("space"),ot("programId")])},AdvanceNonceAccount:{index:4,layout:v.struct([v.u32("instruction")])},WithdrawNonceAccount:{index:5,layout:v.struct([v.u32("instruction"),v.ns64("lamports")])},InitializeNonceAccount:{index:6,layout:v.struct([v.u32("instruction"),ot("authorized")])},AuthorizeNonceAccount:{index:7,layout:v.struct([v.u32("instruction"),ot("authorized")])},Allocate:{index:8,layout:v.struct([v.u32("instruction"),v.ns64("space")])},AllocateWithSeed:{index:9,layout:v.struct([v.u32("instruction"),ot("base"),Bn("seed"),v.ns64("space"),ot("programId")])},AssignWithSeed:{index:10,layout:v.struct([v.u32("instruction"),ot("base"),Bn("seed"),ot("programId")])},TransferWithSeed:{index:11,layout:v.struct([v.u32("instruction"),In("lamports"),Bn("seed"),ot("programId")])},UpgradeNonceAccount:{index:12,layout:v.struct([v.u32("instruction")])}}),Ae=class r{constructor(){}static createAccount(t){let e=De.Create,n=at(e,{lamports:t.lamports,space:t.space,programId:ut(t.programId.toBuffer())});return new mt({keys:[{pubkey:t.fromPubkey,isSigner:!0,isWritable:!0},{pubkey:t.newAccountPubkey,isSigner:!0,isWritable:!0}],programId:this.programId,data:n})}static transfer(t){let e,n;if("basePubkey"in t){let s=De.TransferWithSeed;e=at(s,{lamports:BigInt(t.lamports),seed:t.seed,programId:ut(t.programId.toBuffer())}),n=[{pubkey:t.fromPubkey,isSigner:!1,isWritable:!0},{pubkey:t.basePubkey,isSigner:!0,isWritable:!1},{pubkey:t.toPubkey,isSigner:!1,isWritable:!0}]}else{let s=De.Transfer;e=at(s,{lamports:BigInt(t.lamports)}),n=[{pubkey:t.fromPubkey,isSigner:!0,isWritable:!0},{pubkey:t.toPubkey,isSigner:!1,isWritable:!0}]}return new mt({keys:n,programId:this.programId,data:e})}static assign(t){let e,n;if("basePubkey"in t){let s=De.AssignWithSeed;e=at(s,{base:ut(t.basePubkey.toBuffer()),seed:t.seed,programId:ut(t.programId.toBuffer())}),n=[{pubkey:t.accountPubkey,isSigner:!1,isWritable:!0},{pubkey:t.basePubkey,isSigner:!0,isWritable:!1}]}else{let s=De.Assign;e=at(s,{programId:ut(t.programId.toBuffer())}),n=[{pubkey:t.accountPubkey,isSigner:!0,isWritable:!0}]}return new mt({keys:n,programId:this.programId,data:e})}static createAccountWithSeed(t){let e=De.CreateWithSeed,n=at(e,{base:ut(t.basePubkey.toBuffer()),seed:t.seed,lamports:t.lamports,space:t.space,programId:ut(t.programId.toBuffer())}),s=[{pubkey:t.fromPubkey,isSigner:!0,isWritable:!0},{pubkey:t.newAccountPubkey,isSigner:!1,isWritable:!0}];return t.basePubkey.equals(t.fromPubkey)||s.push({pubkey:t.basePubkey,isSigner:!0,isWritable:!1}),new mt({keys:s,programId:this.programId,data:n})}static createNonceAccount(t){let e=new dt;"basePubkey"in t&&"seed"in t?e.add(r.createAccountWithSeed({fromPubkey:t.fromPubkey,newAccountPubkey:t.noncePubkey,basePubkey:t.basePubkey,seed:t.seed,lamports:t.lamports,space:kf,programId:this.programId})):e.add(r.createAccount({fromPubkey:t.fromPubkey,newAccountPubkey:t.noncePubkey,lamports:t.lamports,space:kf,programId:this.programId}));let n={noncePubkey:t.noncePubkey,authorizedPubkey:t.authorizedPubkey};return e.add(this.nonceInitialize(n)),e}static nonceInitialize(t){let e=De.InitializeNonceAccount,n=at(e,{authorized:ut(t.authorizedPubkey.toBuffer())}),s={keys:[{pubkey:t.noncePubkey,isSigner:!1,isWritable:!0},{pubkey:Ia,isSigner:!1,isWritable:!1},{pubkey:os,isSigner:!1,isWritable:!1}],programId:this.programId,data:n};return new mt(s)}static nonceAdvance(t){let e=De.AdvanceNonceAccount,n=at(e),s={keys:[{pubkey:t.noncePubkey,isSigner:!1,isWritable:!0},{pubkey:Ia,isSigner:!1,isWritable:!1},{pubkey:t.authorizedPubkey,isSigner:!0,isWritable:!1}],programId:this.programId,data:n};return new mt(s)}static nonceWithdraw(t){let e=De.WithdrawNonceAccount,n=at(e,{lamports:t.lamports});return new mt({keys:[{pubkey:t.noncePubkey,isSigner:!1,isWritable:!0},{pubkey:t.toPubkey,isSigner:!1,isWritable:!0},{pubkey:Ia,isSigner:!1,isWritable:!1},{pubkey:os,isSigner:!1,isWritable:!1},{pubkey:t.authorizedPubkey,isSigner:!0,isWritable:!1}],programId:this.programId,data:n})}static nonceAuthorize(t){let e=De.AuthorizeNonceAccount,n=at(e,{authorized:ut(t.newAuthorizedPubkey.toBuffer())});return new mt({keys:[{pubkey:t.noncePubkey,isSigner:!1,isWritable:!0},{pubkey:t.authorizedPubkey,isSigner:!0,isWritable:!1}],programId:this.programId,data:n})}static allocate(t){let e,n;if("basePubkey"in t){let s=De.AllocateWithSeed;e=at(s,{base:ut(t.basePubkey.toBuffer()),seed:t.seed,space:t.space,programId:ut(t.programId.toBuffer())}),n=[{pubkey:t.accountPubkey,isSigner:!1,isWritable:!0},{pubkey:t.basePubkey,isSigner:!0,isWritable:!1}]}else{let s=De.Allocate;e=at(s,{space:t.space}),n=[{pubkey:t.accountPubkey,isSigner:!0,isWritable:!0}]}return new mt({keys:n,programId:this.programId,data:e})}};Ae.programId=new rt("11111111111111111111111111111111");var M0=Jr-300,za=class r{constructor(){}static getMinNumSignatures(t){return 2*(Math.ceil(t/r.chunkSize)+1+1)}static async load(t,e,n,s,i){{let k=await t.getMinimumBalanceForRentExemption(i.length),I=await t.getAccountInfo(n.publicKey,"confirmed"),B=null;if(I!==null){if(I.executable)return console.error("Program load failed, account is already executable"),!1;I.data.length!==i.length&&(B=B||new dt,B.add(Ae.allocate({accountPubkey:n.publicKey,space:i.length}))),I.owner.equals(s)||(B=B||new dt,B.add(Ae.assign({accountPubkey:n.publicKey,programId:s}))),I.lamports<k&&(B=B||new dt,B.add(Ae.transfer({fromPubkey:e.publicKey,toPubkey:n.publicKey,lamports:k-I.lamports})))}else B=new dt().add(Ae.createAccount({fromPubkey:e.publicKey,newAccountPubkey:n.publicKey,lamports:k>0?k:1,space:i.length,programId:s}));B!==null&&await vf(t,B,[e,n],{commitment:"confirmed"})}let o=v.struct([v.u32("instruction"),v.u32("offset"),v.u32("bytesLength"),v.u32("bytesLengthPadding"),v.seq(v.u8("byte"),v.offset(v.u32(),-8),"bytes")]),h=r.chunkSize,f=0,b=i,w=[];for(;b.length>0;){let k=b.slice(0,h),I=Q.Buffer.alloc(h+16);o.encode({instruction:0,offset:f,bytes:k,bytesLength:0,bytesLengthPadding:0},I);let B=new dt().add({keys:[{pubkey:n.publicKey,isSigner:!0,isWritable:!0}],programId:s,data:I});w.push(vf(t,B,[e,n],{commitment:"confirmed"})),t._rpcEndpoint.includes("solana.com")&&await _0(1e3/4),f+=h,b=b.slice(h)}await Promise.all(w);{let k=v.struct([v.u32("instruction")]),I=Q.Buffer.alloc(k.span);k.encode({instruction:1},I);let B=new dt().add({keys:[{pubkey:n.publicKey,isSigner:!0,isWritable:!0},{pubkey:os,isSigner:!1,isWritable:!1}],programId:s,data:I}),O="processed",L=await t.sendTransaction(B,[e,n],{preflightCommitment:O}),{context:E,value:M}=await t.confirmTransaction({signature:L,lastValidBlockHeight:B.lastValidBlockHeight,blockhash:B.recentBlockhash},O);if(M.err)throw new Error(`Transaction ${L} failed (${JSON.stringify(M)})`);for(;;){try{if(await t.getSlot({commitment:O})>E.slot)break}catch{}await new Promise(U=>setTimeout(U,Math.round(I0/2)))}}return!0}};za.chunkSize=M0;var im=new rt("BPFLoader2111111111111111111111111111111111");var om=globalThis.fetch;var am={index:1,layout:v.struct([v.u32("typeIndex"),In("deactivationSlot"),v.nu64("lastExtendedSlot"),v.u8("lastExtendedStartIndex"),v.u8(),v.seq(ot(),v.offset(v.u8(),-1),"authority")])};var Nt=Sn(vi(rt),z(),r=>new rt(r)),Of=ki([z(),Bt("base64")]),ja=Sn(vi(Q.Buffer),Of,r=>Q.Buffer.from(r[0],"base64")),cm=30*1e3;function Nf(r){return me([C({jsonrpc:Bt("2.0"),id:z(),result:r}),C({jsonrpc:Bt("2.0"),id:z(),error:C({code:Yr(),message:z(),data:J(Ru())})})])}var P0=Nf(Yr());function bt(r){return Sn(Nf(r),P0,t=>"error"in t?t:{...t,result:kn(t.result,r)})}function Ge(r){return bt(C({context:C({slot:_()}),value:r}))}function zi(r){return C({context:C({slot:_()}),value:r})}var C0=C({foundation:_(),foundationTerm:_(),initial:_(),taper:_(),terminal:_()}),um=bt(D(K(C({epoch:_(),effectiveSlot:_(),amount:_(),postBalance:_(),commission:J(K(_()))})))),O0=D(C({slot:_(),prioritizationFee:_()})),N0=C({total:_(),validator:_(),foundation:_(),epoch:_()}),U0=C({epoch:_(),slotIndex:_(),slotsInEpoch:_(),absoluteSlot:_(),blockHeight:J(_()),transactionCount:J(_())}),z0=C({slotsPerEpoch:_(),leaderScheduleSlotOffset:_(),warmup:je(),firstNormalEpoch:_(),firstNormalSlot:_()}),W0=la(z(),D(_())),Xr=K(me([C({}),z()])),F0=C({err:Xr}),q0=Bt("receivedSignature"),fm=C({"solana-core":z(),"feature-set":J(_())}),D0=C({program:z(),programId:Nt,parsed:Yr()}),K0=C({programId:Nt,accounts:D(Nt),data:z()}),lm=Ge(C({err:K(me([C({}),z()])),logs:K(D(z())),accounts:J(K(D(K(C({executable:je(),owner:z(),lamports:_(),data:D(z()),rentEpoch:J(_())}))))),unitsConsumed:J(_()),returnData:J(K(C({programId:z(),data:ki([z(),Bt("base64")])}))),innerInstructions:J(K(D(C({index:_(),instructions:D(me([D0,K0]))}))))})),hm=Ge(C({byIdentity:la(z(),D(_())),range:C({firstSlot:_(),lastSlot:_()})}));var dm=bt(C0),pm=bt(N0),ym=bt(O0),gm=bt(U0),mm=bt(z0),wm=bt(W0),bm=bt(_()),xm=Ge(C({total:_(),circulating:_(),nonCirculating:_(),nonCirculatingAccounts:D(Nt)})),H0=C({amount:z(),uiAmount:K(_()),decimals:_(),uiAmountString:J(z())}),vm=Ge(D(C({address:Nt,amount:z(),uiAmount:K(_()),decimals:_(),uiAmountString:J(z())}))),km=Ge(D(C({pubkey:Nt,account:C({executable:je(),owner:Nt,lamports:_(),data:ja,rentEpoch:_()})}))),Wa=C({program:z(),parsed:Yr(),space:_()}),Sm=Ge(D(C({pubkey:Nt,account:C({executable:je(),owner:Nt,lamports:_(),data:Wa,rentEpoch:_()})}))),Bm=Ge(D(C({lamports:_(),address:Nt}))),Ga=C({executable:je(),owner:Nt,lamports:_(),data:ja,rentEpoch:_()}),Em=C({pubkey:Nt,account:Ga}),V0=Sn(me([vi(Q.Buffer),Wa]),me([Of,Wa]),r=>Array.isArray(r)?kn(r,ja):r),$0=C({executable:je(),owner:Nt,lamports:_(),data:V0,rentEpoch:_()}),Im=C({pubkey:Nt,account:$0}),_m=C({state:me([Bt("active"),Bt("inactive"),Bt("activating"),Bt("deactivating")]),active:_(),inactive:_()}),Am=bt(D(C({signature:z(),slot:_(),err:Xr,memo:K(z()),blockTime:J(K(_()))}))),Lm=bt(D(C({signature:z(),slot:_(),err:Xr,memo:K(z()),blockTime:J(K(_()))}))),Rm=C({subscription:_(),result:zi(Ga)}),j0=C({pubkey:Nt,account:Ga}),Tm=C({subscription:_(),result:zi(j0)}),G0=C({parent:_(),slot:_(),root:_()}),Mm=C({subscription:_(),result:G0}),Z0=me([C({type:me([Bt("firstShredReceived"),Bt("completed"),Bt("optimisticConfirmation"),Bt("root")]),slot:_(),timestamp:_()}),C({type:Bt("createdBank"),parent:_(),slot:_(),timestamp:_()}),C({type:Bt("frozen"),slot:_(),timestamp:_(),stats:C({numTransactionEntries:_(),numSuccessfulTransactions:_(),numFailedTransactions:_(),maxTransactionsPerEntry:_()})}),C({type:Bt("dead"),slot:_(),timestamp:_(),err:z()})]),Pm=C({subscription:_(),result:Z0}),Cm=C({subscription:_(),result:zi(me([F0,q0]))}),Om=C({subscription:_(),result:_()}),Nm=C({pubkey:z(),gossip:K(z()),tpu:K(z()),rpc:K(z()),version:K(z())}),Sf=C({votePubkey:z(),nodePubkey:z(),activatedStake:_(),epochVoteAccount:je(),epochCredits:D(ki([_(),_(),_()])),commission:_(),lastVote:_(),rootSlot:K(_())}),Um=bt(C({current:D(Sf),delinquent:D(Sf)})),Y0=me([Bt("processed"),Bt("confirmed"),Bt("finalized")]),J0=C({slot:_(),confirmations:K(_()),err:Xr,confirmationStatus:J(Y0)}),zm=Ge(D(K(J0))),Wm=bt(_()),Uf=C({accountKey:Nt,writableIndexes:D(_()),readonlyIndexes:D(_())}),Za=C({signatures:D(z()),message:C({accountKeys:D(z()),header:C({numRequiredSignatures:_(),numReadonlySignedAccounts:_(),numReadonlyUnsignedAccounts:_()}),instructions:D(C({accounts:D(_()),data:z(),programIdIndex:_()})),recentBlockhash:z(),addressTableLookups:J(D(Uf))})}),zf=C({pubkey:Nt,signer:je(),writable:je(),source:J(me([Bt("transaction"),Bt("lookupTable")]))}),Wf=C({accountKeys:D(zf),signatures:D(z())}),Ff=C({parsed:Yr(),program:z(),programId:Nt}),qf=C({accounts:D(Nt),data:z(),programId:Nt}),X0=me([qf,Ff]),Q0=me([C({parsed:Yr(),program:z(),programId:z()}),C({accounts:D(z()),data:z(),programId:z()})]),Df=Sn(X0,Q0,r=>"accounts"in r?kn(r,qf):kn(r,Ff)),Kf=C({signatures:D(z()),message:C({accountKeys:D(zf),instructions:D(Df),recentBlockhash:z(),addressTableLookups:J(K(D(Uf)))})}),Oi=C({accountIndex:_(),mint:z(),owner:J(z()),programId:J(z()),uiTokenAmount:H0}),Hf=C({writable:D(Nt),readonly:D(Nt)}),Wi=C({err:Xr,fee:_(),innerInstructions:J(K(D(C({index:_(),instructions:D(C({accounts:D(_()),data:z(),programIdIndex:_()}))})))),preBalances:D(_()),postBalances:D(_()),logMessages:J(K(D(z()))),preTokenBalances:J(K(D(Oi))),postTokenBalances:J(K(D(Oi))),loadedAddresses:J(Hf),computeUnitsConsumed:J(_())}),Ya=C({err:Xr,fee:_(),innerInstructions:J(K(D(C({index:_(),instructions:D(Df)})))),preBalances:D(_()),postBalances:D(_()),logMessages:J(K(D(z()))),preTokenBalances:J(K(D(Oi))),postTokenBalances:J(K(D(Oi))),loadedAddresses:J(Hf),computeUnitsConsumed:J(_())}),An=me([Bt(0),Bt("legacy")]),Qr=C({pubkey:z(),lamports:_(),postBalance:K(_()),rewardType:K(z()),commission:J(K(_()))}),Fm=bt(K(C({blockhash:z(),previousBlockhash:z(),parentSlot:_(),transactions:D(C({transaction:Za,meta:K(Wi),version:J(An)})),rewards:J(D(Qr)),blockTime:K(_()),blockHeight:K(_())}))),qm=bt(K(C({blockhash:z(),previousBlockhash:z(),parentSlot:_(),rewards:J(D(Qr)),blockTime:K(_()),blockHeight:K(_())}))),Dm=bt(K(C({blockhash:z(),previousBlockhash:z(),parentSlot:_(),transactions:D(C({transaction:Wf,meta:K(Wi),version:J(An)})),rewards:J(D(Qr)),blockTime:K(_()),blockHeight:K(_())}))),Km=bt(K(C({blockhash:z(),previousBlockhash:z(),parentSlot:_(),transactions:D(C({transaction:Kf,meta:K(Ya),version:J(An)})),rewards:J(D(Qr)),blockTime:K(_()),blockHeight:K(_())}))),Hm=bt(K(C({blockhash:z(),previousBlockhash:z(),parentSlot:_(),transactions:D(C({transaction:Wf,meta:K(Ya),version:J(An)})),rewards:J(D(Qr)),blockTime:K(_()),blockHeight:K(_())}))),Vm=bt(K(C({blockhash:z(),previousBlockhash:z(),parentSlot:_(),rewards:J(D(Qr)),blockTime:K(_()),blockHeight:K(_())}))),$m=bt(K(C({blockhash:z(),previousBlockhash:z(),parentSlot:_(),transactions:D(C({transaction:Za,meta:K(Wi)})),rewards:J(D(Qr)),blockTime:K(_())}))),jm=bt(K(C({blockhash:z(),previousBlockhash:z(),parentSlot:_(),signatures:D(z()),blockTime:K(_())}))),Gm=bt(K(C({slot:_(),meta:K(Wi),blockTime:J(K(_())),transaction:Za,version:J(An)}))),Zm=bt(K(C({slot:_(),transaction:Kf,meta:K(Ya),blockTime:J(K(_())),version:J(An)}))),Ym=Ge(C({blockhash:z(),lastValidBlockHeight:_()})),Jm=Ge(je()),tp=C({slot:_(),numTransactions:_(),numSlots:_(),samplePeriodSecs:_()}),Xm=bt(D(tp)),Qm=Ge(K(C({feeCalculator:C({lamportsPerSignature:_()})}))),tw=bt(z()),ew=bt(z()),ep=C({err:Xr,logs:D(z()),signature:z()}),rw=C({result:zi(ep),subscription:_()});var Fa=class r{constructor(t){this._keypair=void 0,this._keypair=t??wf()}static generate(){return new r(wf())}static fromSecretKey(t,e){if(t.byteLength!==64)throw new Error("bad secret key size");let n=t.slice(32,64);if(!e||!e.skipValidation){let s=t.slice(0,32),i=Ta(s);for(let o=0;o<32;o++)if(n[o]!==i[o])throw new Error("provided secretKey is invalid")}return new r({publicKey:n,secretKey:t})}static fromSeed(t){let e=Ta(t),n=new Uint8Array(64);return n.set(t),n.set(e,32),new r({publicKey:e,secretKey:n})}get publicKey(){return new rt(this._keypair.publicKey)}get secretKey(){return new Uint8Array(this._keypair.secretKey)}},rs=Object.freeze({CreateLookupTable:{index:0,layout:v.struct([v.u32("instruction"),In("recentSlot"),v.u8("bumpSeed")])},FreezeLookupTable:{index:1,layout:v.struct([v.u32("instruction")])},ExtendLookupTable:{index:2,layout:v.struct([v.u32("instruction"),In(),v.seq(ot(),v.offset(v.u32(),-8),"addresses")])},DeactivateLookupTable:{index:3,layout:v.struct([v.u32("instruction")])},CloseLookupTable:{index:4,layout:v.struct([v.u32("instruction")])}});var qa=class{constructor(){}static createLookupTable(t){let[e,n]=rt.findProgramAddressSync([t.authority.toBuffer(),(0,cs.toBufferLE)(BigInt(t.recentSlot),8)],this.programId),s=rs.CreateLookupTable,i=at(s,{recentSlot:BigInt(t.recentSlot),bumpSeed:n}),o=[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:t.authority,isSigner:!0,isWritable:!1},{pubkey:t.payer,isSigner:!0,isWritable:!0},{pubkey:Ae.programId,isSigner:!1,isWritable:!1}];return[new mt({programId:this.programId,keys:o,data:i}),e]}static freezeLookupTable(t){let e=rs.FreezeLookupTable,n=at(e),s=[{pubkey:t.lookupTable,isSigner:!1,isWritable:!0},{pubkey:t.authority,isSigner:!0,isWritable:!1}];return new mt({programId:this.programId,keys:s,data:n})}static extendLookupTable(t){let e=rs.ExtendLookupTable,n=at(e,{addresses:t.addresses.map(i=>i.toBytes())}),s=[{pubkey:t.lookupTable,isSigner:!1,isWritable:!0},{pubkey:t.authority,isSigner:!0,isWritable:!1}];return t.payer&&s.push({pubkey:t.payer,isSigner:!0,isWritable:!0},{pubkey:Ae.programId,isSigner:!1,isWritable:!1}),new mt({programId:this.programId,keys:s,data:n})}static deactivateLookupTable(t){let e=rs.DeactivateLookupTable,n=at(e),s=[{pubkey:t.lookupTable,isSigner:!1,isWritable:!0},{pubkey:t.authority,isSigner:!0,isWritable:!1}];return new mt({programId:this.programId,keys:s,data:n})}static closeLookupTable(t){let e=rs.CloseLookupTable,n=at(e),s=[{pubkey:t.lookupTable,isSigner:!1,isWritable:!0},{pubkey:t.authority,isSigner:!0,isWritable:!1},{pubkey:t.recipient,isSigner:!1,isWritable:!0}];return new mt({programId:this.programId,keys:s,data:n})}};qa.programId=new rt("AddressLookupTab1e1111111111111111111111111");var Ti=Object.freeze({RequestUnits:{index:0,layout:v.struct([v.u8("instruction"),v.u32("units"),v.u32("additionalFee")])},RequestHeapFrame:{index:1,layout:v.struct([v.u8("instruction"),v.u32("bytes")])},SetComputeUnitLimit:{index:2,layout:v.struct([v.u8("instruction"),v.u32("units")])},SetComputeUnitPrice:{index:3,layout:v.struct([v.u8("instruction"),In("microLamports")])}}),Da=class{constructor(){}static requestUnits(t){let e=Ti.RequestUnits,n=at(e,t);return new mt({keys:[],programId:this.programId,data:n})}static requestHeapFrame(t){let e=Ti.RequestHeapFrame,n=at(e,t);return new mt({keys:[],programId:this.programId,data:n})}static setComputeUnitLimit(t){let e=Ti.SetComputeUnitLimit,n=at(e,t);return new mt({keys:[],programId:this.programId,data:n})}static setComputeUnitPrice(t){let e=Ti.SetComputeUnitPrice,n=at(e,{microLamports:BigInt(t.microLamports)});return new mt({keys:[],programId:this.programId,data:n})}};Da.programId=new rt("ComputeBudget111111111111111111111111111111");var Bf=64,Ef=32,If=64,_f=v.struct([v.u8("numSignatures"),v.u8("padding"),v.u16("signatureOffset"),v.u16("signatureInstructionIndex"),v.u16("publicKeyOffset"),v.u16("publicKeyInstructionIndex"),v.u16("messageDataOffset"),v.u16("messageDataSize"),v.u16("messageInstructionIndex")]),Ka=class r{constructor(){}static createInstructionWithPublicKey(t){let{publicKey:e,message:n,signature:s,instructionIndex:i}=t;vt(e.length===Ef,`Public Key must be ${Ef} bytes but received ${e.length} bytes`),vt(s.length===If,`Signature must be ${If} bytes but received ${s.length} bytes`);let o=_f.span,h=o+e.length,f=h+s.length,b=1,w=Q.Buffer.alloc(f+n.length),k=i??65535;return _f.encode({numSignatures:b,padding:0,signatureOffset:h,signatureInstructionIndex:k,publicKeyOffset:o,publicKeyInstructionIndex:k,messageDataOffset:f,messageDataSize:n.length,messageInstructionIndex:k},w),w.fill(e,o),w.fill(s,h),w.fill(n,f),new mt({keys:[],programId:r.programId,data:w})}static createInstructionWithPrivateKey(t){let{privateKey:e,message:n,instructionIndex:s}=t;vt(e.length===Bf,`Private key must be ${Bf} bytes but received ${e.length} bytes`);try{let i=Fa.fromSecretKey(e),o=i.publicKey.toBytes(),h=Va(n,i.secretKey);return this.createInstructionWithPublicKey({publicKey:o,message:n,signature:h,instructionIndex:s})}catch(i){throw new Error(`Error creating instruction; ${i}`)}}};Ka.programId=new rt("Ed25519SigVerify111111111111111111111111111");var rp=(r,t)=>{let e=es.sign(r,t);return[e.toCompactRawBytes(),e.recovery]};es.utils.isValidPrivateKey;var np=es.getPublicKey,Af=32,Aa=20,Lf=64,sp=11,La=v.struct([v.u8("numSignatures"),v.u16("signatureOffset"),v.u8("signatureInstructionIndex"),v.u16("ethAddressOffset"),v.u8("ethAddressInstructionIndex"),v.u16("messageDataOffset"),v.u16("messageDataSize"),v.u8("messageInstructionIndex"),v.blob(20,"ethAddress"),v.blob(64,"signature"),v.u8("recoveryId")]),Ha=class r{constructor(){}static publicKeyToEthAddress(t){vt(t.length===Lf,`Public key must be ${Lf} bytes but received ${t.length} bytes`);try{return Q.Buffer.from(ka(ut(t))).slice(-Aa)}catch(e){throw new Error(`Error constructing Ethereum address: ${e}`)}}static createInstructionWithPublicKey(t){let{publicKey:e,message:n,signature:s,recoveryId:i,instructionIndex:o}=t;return r.createInstructionWithEthAddress({ethAddress:r.publicKeyToEthAddress(e),message:n,signature:s,recoveryId:i,instructionIndex:o})}static createInstructionWithEthAddress(t){let{ethAddress:e,message:n,signature:s,recoveryId:i,instructionIndex:o=0}=t,h;typeof e=="string"?e.startsWith("0x")?h=Q.Buffer.from(e.substr(2),"hex"):h=Q.Buffer.from(e,"hex"):h=e,vt(h.length===Aa,`Address must be ${Aa} bytes but received ${h.length} bytes`);let f=1+sp,b=f,w=f+h.length,k=w+s.length+1,I=1,B=Q.Buffer.alloc(La.span+n.length);return La.encode({numSignatures:I,signatureOffset:w,signatureInstructionIndex:o,ethAddressOffset:b,ethAddressInstructionIndex:o,messageDataOffset:k,messageDataSize:n.length,messageInstructionIndex:o,signature:ut(s),ethAddress:ut(h),recoveryId:i},B),B.fill(ut(n),La.span),new mt({keys:[],programId:r.programId,data:B})}static createInstructionWithPrivateKey(t){let{privateKey:e,message:n,instructionIndex:s}=t;vt(e.length===Af,`Private key must be ${Af} bytes but received ${e.length} bytes`);try{let i=ut(e),o=np(i,!1).slice(1),h=Q.Buffer.from(ka(ut(n))),[f,b]=rp(h,i);return this.createInstructionWithPublicKey({publicKey:o,message:n,signature:f,recoveryId:b,instructionIndex:s})}catch(i){throw new Error(`Error creating instruction; ${i}`)}}};Ha.programId=new rt("KeccakSecp256k11111111111111111111111111111");var Vf,ip=new rt("StakeConfig11111111111111111111111111111111");var as=class{constructor(t,e,n){this.unixTimestamp=void 0,this.epoch=void 0,this.custodian=void 0,this.unixTimestamp=t,this.epoch=e,this.custodian=n}};Vf=as;as.default=new Vf(0,0,rt.default);var Or=Object.freeze({Initialize:{index:0,layout:v.struct([v.u32("instruction"),w0(),b0()])},Authorize:{index:1,layout:v.struct([v.u32("instruction"),ot("newAuthorized"),v.u32("stakeAuthorizationType")])},Delegate:{index:2,layout:v.struct([v.u32("instruction")])},Split:{index:3,layout:v.struct([v.u32("instruction"),v.ns64("lamports")])},Withdraw:{index:4,layout:v.struct([v.u32("instruction"),v.ns64("lamports")])},Deactivate:{index:5,layout:v.struct([v.u32("instruction")])},Merge:{index:7,layout:v.struct([v.u32("instruction")])},AuthorizeWithSeed:{index:8,layout:v.struct([v.u32("instruction"),ot("newAuthorized"),v.u32("stakeAuthorizationType"),Bn("authoritySeed"),ot("authorityOwner")])}}),nw=Object.freeze({Staker:{index:0},Withdrawer:{index:1}}),Ni=class{constructor(){}static initialize(t){let{stakePubkey:e,authorized:n,lockup:s}=t,i=s||as.default,o=Or.Initialize,h=at(o,{authorized:{staker:ut(n.staker.toBuffer()),withdrawer:ut(n.withdrawer.toBuffer())},lockup:{unixTimestamp:i.unixTimestamp,epoch:i.epoch,custodian:ut(i.custodian.toBuffer())}}),f={keys:[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:os,isSigner:!1,isWritable:!1}],programId:this.programId,data:h};return new mt(f)}static createAccountWithSeed(t){let e=new dt;e.add(Ae.createAccountWithSeed({fromPubkey:t.fromPubkey,newAccountPubkey:t.stakePubkey,basePubkey:t.basePubkey,seed:t.seed,lamports:t.lamports,space:this.space,programId:this.programId}));let{stakePubkey:n,authorized:s,lockup:i}=t;return e.add(this.initialize({stakePubkey:n,authorized:s,lockup:i}))}static createAccount(t){let e=new dt;e.add(Ae.createAccount({fromPubkey:t.fromPubkey,newAccountPubkey:t.stakePubkey,lamports:t.lamports,space:this.space,programId:this.programId}));let{stakePubkey:n,authorized:s,lockup:i}=t;return e.add(this.initialize({stakePubkey:n,authorized:s,lockup:i}))}static delegate(t){let{stakePubkey:e,authorizedPubkey:n,votePubkey:s}=t,i=Or.Delegate,o=at(i);return new dt().add({keys:[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:s,isSigner:!1,isWritable:!1},{pubkey:pr,isSigner:!1,isWritable:!1},{pubkey:_a,isSigner:!1,isWritable:!1},{pubkey:ip,isSigner:!1,isWritable:!1},{pubkey:n,isSigner:!0,isWritable:!1}],programId:this.programId,data:o})}static authorize(t){let{stakePubkey:e,authorizedPubkey:n,newAuthorizedPubkey:s,stakeAuthorizationType:i,custodianPubkey:o}=t,h=Or.Authorize,f=at(h,{newAuthorized:ut(s.toBuffer()),stakeAuthorizationType:i.index}),b=[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:pr,isSigner:!1,isWritable:!0},{pubkey:n,isSigner:!0,isWritable:!1}];return o&&b.push({pubkey:o,isSigner:!0,isWritable:!1}),new dt().add({keys:b,programId:this.programId,data:f})}static authorizeWithSeed(t){let{stakePubkey:e,authorityBase:n,authoritySeed:s,authorityOwner:i,newAuthorizedPubkey:o,stakeAuthorizationType:h,custodianPubkey:f}=t,b=Or.AuthorizeWithSeed,w=at(b,{newAuthorized:ut(o.toBuffer()),stakeAuthorizationType:h.index,authoritySeed:s,authorityOwner:ut(i.toBuffer())}),k=[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:n,isSigner:!0,isWritable:!1},{pubkey:pr,isSigner:!1,isWritable:!1}];return f&&k.push({pubkey:f,isSigner:!0,isWritable:!1}),new dt().add({keys:k,programId:this.programId,data:w})}static splitInstruction(t){let{stakePubkey:e,authorizedPubkey:n,splitStakePubkey:s,lamports:i}=t,o=Or.Split,h=at(o,{lamports:i});return new mt({keys:[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:s,isSigner:!1,isWritable:!0},{pubkey:n,isSigner:!0,isWritable:!1}],programId:this.programId,data:h})}static split(t,e){let n=new dt;return n.add(Ae.createAccount({fromPubkey:t.authorizedPubkey,newAccountPubkey:t.splitStakePubkey,lamports:e,space:this.space,programId:this.programId})),n.add(this.splitInstruction(t))}static splitWithSeed(t,e){let{stakePubkey:n,authorizedPubkey:s,splitStakePubkey:i,basePubkey:o,seed:h,lamports:f}=t,b=new dt;return b.add(Ae.allocate({accountPubkey:i,basePubkey:o,seed:h,space:this.space,programId:this.programId})),e&&e>0&&b.add(Ae.transfer({fromPubkey:t.authorizedPubkey,toPubkey:i,lamports:e})),b.add(this.splitInstruction({stakePubkey:n,authorizedPubkey:s,splitStakePubkey:i,lamports:f}))}static merge(t){let{stakePubkey:e,sourceStakePubKey:n,authorizedPubkey:s}=t,i=Or.Merge,o=at(i);return new dt().add({keys:[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:n,isSigner:!1,isWritable:!0},{pubkey:pr,isSigner:!1,isWritable:!1},{pubkey:_a,isSigner:!1,isWritable:!1},{pubkey:s,isSigner:!0,isWritable:!1}],programId:this.programId,data:o})}static withdraw(t){let{stakePubkey:e,authorizedPubkey:n,toPubkey:s,lamports:i,custodianPubkey:o}=t,h=Or.Withdraw,f=at(h,{lamports:i}),b=[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:s,isSigner:!1,isWritable:!0},{pubkey:pr,isSigner:!1,isWritable:!1},{pubkey:_a,isSigner:!1,isWritable:!1},{pubkey:n,isSigner:!0,isWritable:!1}];return o&&b.push({pubkey:o,isSigner:!0,isWritable:!1}),new dt().add({keys:b,programId:this.programId,data:f})}static deactivate(t){let{stakePubkey:e,authorizedPubkey:n}=t,s=Or.Deactivate,i=at(s);return new dt().add({keys:[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:pr,isSigner:!1,isWritable:!1},{pubkey:n,isSigner:!0,isWritable:!1}],programId:this.programId,data:i})}};Ni.programId=new rt("Stake11111111111111111111111111111111111111");Ni.space=200;var ns=Object.freeze({InitializeAccount:{index:0,layout:v.struct([v.u32("instruction"),x0()])},Authorize:{index:1,layout:v.struct([v.u32("instruction"),ot("newAuthorized"),v.u32("voteAuthorizationType")])},Withdraw:{index:3,layout:v.struct([v.u32("instruction"),v.ns64("lamports")])},UpdateValidatorIdentity:{index:4,layout:v.struct([v.u32("instruction")])},AuthorizeWithSeed:{index:10,layout:v.struct([v.u32("instruction"),v0()])}}),sw=Object.freeze({Voter:{index:0},Withdrawer:{index:1}}),Ui=class r{constructor(){}static initializeAccount(t){let{votePubkey:e,nodePubkey:n,voteInit:s}=t,i=ns.InitializeAccount,o=at(i,{voteInit:{nodePubkey:ut(s.nodePubkey.toBuffer()),authorizedVoter:ut(s.authorizedVoter.toBuffer()),authorizedWithdrawer:ut(s.authorizedWithdrawer.toBuffer()),commission:s.commission}}),h={keys:[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:os,isSigner:!1,isWritable:!1},{pubkey:pr,isSigner:!1,isWritable:!1},{pubkey:n,isSigner:!0,isWritable:!1}],programId:this.programId,data:o};return new mt(h)}static createAccount(t){let e=new dt;return e.add(Ae.createAccount({fromPubkey:t.fromPubkey,newAccountPubkey:t.votePubkey,lamports:t.lamports,space:this.space,programId:this.programId})),e.add(this.initializeAccount({votePubkey:t.votePubkey,nodePubkey:t.voteInit.nodePubkey,voteInit:t.voteInit}))}static authorize(t){let{votePubkey:e,authorizedPubkey:n,newAuthorizedPubkey:s,voteAuthorizationType:i}=t,o=ns.Authorize,h=at(o,{newAuthorized:ut(s.toBuffer()),voteAuthorizationType:i.index}),f=[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:pr,isSigner:!1,isWritable:!1},{pubkey:n,isSigner:!0,isWritable:!1}];return new dt().add({keys:f,programId:this.programId,data:h})}static authorizeWithSeed(t){let{currentAuthorityDerivedKeyBasePubkey:e,currentAuthorityDerivedKeyOwnerPubkey:n,currentAuthorityDerivedKeySeed:s,newAuthorizedPubkey:i,voteAuthorizationType:o,votePubkey:h}=t,f=ns.AuthorizeWithSeed,b=at(f,{voteAuthorizeWithSeedArgs:{currentAuthorityDerivedKeyOwnerPubkey:ut(n.toBuffer()),currentAuthorityDerivedKeySeed:s,newAuthorized:ut(i.toBuffer()),voteAuthorizationType:o.index}}),w=[{pubkey:h,isSigner:!1,isWritable:!0},{pubkey:pr,isSigner:!1,isWritable:!1},{pubkey:e,isSigner:!0,isWritable:!1}];return new dt().add({keys:w,programId:this.programId,data:b})}static withdraw(t){let{votePubkey:e,authorizedWithdrawerPubkey:n,lamports:s,toPubkey:i}=t,o=ns.Withdraw,h=at(o,{lamports:s}),f=[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:i,isSigner:!1,isWritable:!0},{pubkey:n,isSigner:!0,isWritable:!1}];return new dt().add({keys:f,programId:this.programId,data:h})}static safeWithdraw(t,e,n){if(t.lamports>e-n)throw new Error("Withdraw will leave vote account with insufficient funds.");return r.withdraw(t)}static updateValidatorIdentity(t){let{votePubkey:e,authorizedWithdrawerPubkey:n,nodePubkey:s}=t,i=ns.UpdateValidatorIdentity,o=at(i),h=[{pubkey:e,isSigner:!1,isWritable:!0},{pubkey:s,isSigner:!0,isWritable:!1},{pubkey:n,isSigner:!0,isWritable:!1}];return new dt().add({keys:h,programId:this.programId,data:o})}};Ui.programId=new rt("Vote111111111111111111111111111111111111111");Ui.space=3762;var iw=new rt("Va1idator1nfo111111111111111111111111111111"),ow=C({name:z(),website:J(z()),details:J(z()),iconUrl:J(z()),keybaseUsername:J(z())});var aw=new rt("Vote111111111111111111111111111111111111111"),cw=v.struct([ot("nodePubkey"),ot("authorizedWithdrawer"),v.u8("commission"),v.nu64(),v.seq(v.struct([v.nu64("slot"),v.u32("confirmationCount")]),v.offset(v.u32(),-8),"votes"),v.u8("rootSlotValid"),v.nu64("rootSlot"),v.nu64(),v.seq(v.struct([v.nu64("epoch"),ot("authorizedVoter")]),v.offset(v.u32(),-8),"authorizedVoters"),v.struct([v.seq(v.struct([ot("authorizedPubkey"),v.nu64("epochOfLastAuthorizedSwitch"),v.nu64("targetEpoch")]),32,"buf"),v.nu64("idx"),v.u8("isEmpty")],"priorVoters"),v.nu64(),v.seq(v.struct([v.nu64("epoch"),v.nu64("credits"),v.nu64("prevCredits")]),v.offset(v.u32(),-8),"epochCredits"),v.struct([v.nu64("slot"),v.nu64("timestamp")],"lastTimestamp")]);var Yf=Oe(js(),1),ie=function(r,t,e,n,s){if(n==="m")throw new TypeError("Private method is not writable");if(n==="a"&&!s)throw new TypeError("Private accessor was defined without a setter");if(typeof t=="function"?r!==t||!s:!t.has(r))throw new TypeError("Cannot write private member to an object whose class did not declare it");return n==="a"?s.call(r,e):s?s.value=e:t.set(r,e),e},$=function(r,t,e,n){if(e==="a"&&!n)throw new TypeError("Private accessor was defined without a getter");if(typeof t=="function"?r!==t||!n:!t.has(r))throw new TypeError("Cannot read private member from an object whose class did not declare it");return e==="m"?n:e==="a"?n.call(r):n?n.value:t.get(r)},de,Pe,en,rn,tn,us,qi,ft,Di,Ja,Fi,Xa,fs,Qa,$f,jf,Gf,Zf,Ki=class extends _s{constructor({wallet:t}){super(),de.add(this),Pe.set(this,void 0),en.set(this,void 0),rn.set(this,void 0),tn.set(this,void 0),us.set(this,void 0),qi.set(this,void 0),ft.set(this,void 0),Di.set(this,typeof window>"u"||typeof document>"u"?on.Unsupported:on.Installed),Qa.set(this,e=>{if("accounts"in e){let n=$(this,ft,"f").accounts[0];$(this,Pe,"f")&&!$(this,tn,"f")&&n!==$(this,Pe,"f")&&(n?$(this,de,"m",Fi).call(this,n):(this.emit("error",new Ss),$(this,de,"m",Xa).call(this)))}"features"in e&&$(this,de,"m",fs).call(this)}),ie(this,ft,t,"f"),ie(this,Pe,null,"f"),ie(this,en,null,"f"),ie(this,rn,!1,"f"),ie(this,tn,!1,"f"),ie(this,us,$(this,ft,"f").features[bs].on("change",$(this,Qa,"f")),"f"),$(this,de,"m",fs).call(this)}get name(){return $(this,ft,"f").name}get url(){return"https://github.com/solana-labs/wallet-standard"}get icon(){return $(this,ft,"f").icon}get readyState(){return $(this,Di,"f")}get publicKey(){return $(this,en,"f")}get connecting(){return $(this,rn,"f")}get supportedTransactionVersions(){return $(this,qi,"f")}get wallet(){return $(this,ft,"f")}get standard(){return!0}destroy(){ie(this,Pe,null,"f"),ie(this,en,null,"f"),ie(this,rn,!1,"f"),ie(this,tn,!1,"f");let t=$(this,us,"f");t&&(ie(this,us,null,"f"),t())}async autoConnect(){return $(this,de,"m",Ja).call(this,{silent:!0})}async connect(){return $(this,de,"m",Ja).call(this)}async disconnect(){if(ho in $(this,ft,"f").features)try{ie(this,tn,!0,"f"),await $(this,ft,"f").features[ho].disconnect()}catch(t){this.emit("error",new Bs(t?.message,t))}finally{ie(this,tn,!1,"f")}$(this,de,"m",Xa).call(this)}async sendTransaction(t,e,n={}){try{let s=$(this,Pe,"f");if(!s)throw new nr;let i;if(Ze in $(this,ft,"f").features)if(s.features.includes(Ze))i=Ze;else if(oe in $(this,ft,"f").features&&s.features.includes(oe))i=oe;else throw new rr;else if(oe in $(this,ft,"f").features){if(!s.features.includes(oe))throw new rr;i=oe}else throw new gr;let o=Bc(e.rpcEndpoint);if(!s.chains.includes(o))throw new Pn;try{let{signers:h,...f}=n,b;if(an(t)?(h?.length&&t.sign(h),b=t.serialize()):(t=await this.prepareTransaction(t,e,f),h?.length&&t.partialSign(...h),b=new Uint8Array(t.serialize({requireAllSignatures:!1,verifySignatures:!1}))),i===Ze){let[w]=await $(this,ft,"f").features[Ze].signAndSendTransaction({account:s,chain:o,transaction:b,options:{preflightCommitment:Ls(f.preflightCommitment||e.commitment),skipPreflight:f.skipPreflight,maxRetries:f.maxRetries,minContextSlot:f.minContextSlot}});return Yf.default.encode(w.signature)}else{let[w]=await $(this,ft,"f").features[oe].signTransaction({account:s,chain:o,transaction:b,options:{preflightCommitment:Ls(f.preflightCommitment||e.commitment),minContextSlot:f.minContextSlot}});return await e.sendRawTransaction(w.signedTransaction,{...f,preflightCommitment:Ls(f.preflightCommitment||e.commitment)})}}catch(h){throw h instanceof fe?h:new Pn(h?.message,h)}}catch(s){throw this.emit("error",s),s}}};Pe=new WeakMap,en=new WeakMap,rn=new WeakMap,tn=new WeakMap,us=new WeakMap,qi=new WeakMap,ft=new WeakMap,Di=new WeakMap,Qa=new WeakMap,de=new WeakSet,Ja=async function(t){try{if(this.connected||this.connecting)return;if($(this,Di,"f")!==on.Installed)throw new vs;if(ie(this,rn,!0,"f"),!$(this,ft,"f").accounts.length)try{await $(this,ft,"f").features[ws].connect(t)}catch(n){throw new ks(n?.message,n)}let e=$(this,ft,"f").accounts[0];if(!e)throw new rr;$(this,de,"m",Fi).call(this,e)}catch(e){throw this.emit("error",e),e}finally{ie(this,rn,!1,"f")}},Fi=function(t){let e;try{e=new rt(t.address)}catch(n){throw new Es(n?.message,n)}ie(this,Pe,t,"f"),ie(this,en,e,"f"),$(this,de,"m",fs).call(this),this.emit("connect",e)},Xa=function(){ie(this,Pe,null,"f"),ie(this,en,null,"f"),$(this,de,"m",fs).call(this),this.emit("disconnect")},fs=function(){let t=Ze in $(this,ft,"f").features?$(this,ft,"f").features[Ze].supportedTransactionVersions:$(this,ft,"f").features[oe].supportedTransactionVersions;ie(this,qi,gc(t,["legacy"])?null:new Set(t),"f"),oe in $(this,ft,"f").features&&$(this,Pe,"f")?.features.includes(oe)?(this.signTransaction=$(this,de,"m",$f),this.signAllTransactions=$(this,de,"m",jf)):(delete this.signTransaction,delete this.signAllTransactions),cn in $(this,ft,"f").features&&$(this,Pe,"f")?.features.includes(cn)?this.signMessage=$(this,de,"m",Gf):delete this.signMessage,As in $(this,ft,"f").features?this.signIn=$(this,de,"m",Zf):delete this.signIn},$f=async function(t){try{let e=$(this,Pe,"f");if(!e)throw new nr;if(!(oe in $(this,ft,"f").features))throw new gr;if(!e.features.includes(oe))throw new rr;try{let s=(await $(this,ft,"f").features[oe].signTransaction({account:e,transaction:an(t)?t.serialize():new Uint8Array(t.serialize({requireAllSignatures:!1,verifySignatures:!1}))}))[0].signedTransaction;return an(t)?is.deserialize(s):dt.from(s)}catch(n){throw n instanceof fe?n:new Cn(n?.message,n)}}catch(e){throw this.emit("error",e),e}},jf=async function(t){try{let e=$(this,Pe,"f");if(!e)throw new nr;if(!(oe in $(this,ft,"f").features))throw new gr;if(!e.features.includes(oe))throw new rr;try{let n=await $(this,ft,"f").features[oe].signTransaction(...t.map(s=>({account:e,transaction:an(s)?s.serialize():new Uint8Array(s.serialize({requireAllSignatures:!1,verifySignatures:!1}))})));return t.map((s,i)=>{let o=n[i].signedTransaction;return an(s)?is.deserialize(o):dt.from(o)})}catch(n){throw new Cn(n?.message,n)}}catch(e){throw this.emit("error",e),e}},Gf=async function(t){try{let e=$(this,Pe,"f");if(!e)throw new nr;if(!(cn in $(this,ft,"f").features))throw new gr;if(!e.features.includes(cn))throw new rr;try{return(await $(this,ft,"f").features[cn].signMessage({account:e,message:t}))[0].signature}catch(n){throw new Is(n?.message,n)}}catch(e){throw this.emit("error",e),e}},Zf=async function(t={}){try{if(!(As in $(this,ft,"f").features))throw new gr;let e;try{[e]=await $(this,ft,"f").features[As].signIn(t)}catch(n){throw new On(n?.message,n)}if(!e)throw new On;return $(this,de,"m",Fi).call(this,e.account),e}catch(e){throw this.emit("error",e),e}};var Jf=Oe(gn()),Hi=class{constructor(){this.connectedWallet=null;let{get:t,on:e}=yc();this.wallets=[...this.wrapWalletsWithAdapters(t())],e("register",()=>{this.wallets=[...this.wrapWalletsWithAdapters(t())]}),this.autoConnect()}wrapWalletsWithAdapters(t){return t.filter(xc).map(e=>new Ki({wallet:e}))}async autoConnect(){for(let t of this.wallets)try{await t.autoConnect(),this.connectedWallet=t;return}catch(e){console.error(`Failed to auto connect to wallet ${t.name}`,e)}}async signIn(t){let e=this.wallets.find(s=>s.name===t);if(!e)throw new Error(`Wallet with name ${t} not found`);if(!e.signIn)throw new Error(`Wallet with name ${t} does not support signIn`);this.connectedWallet?.disconnect();let n=await e.signIn({domain:window.location.hostname});return await e.autoConnect(),this.connectedWallet=e,n}async signTransaction(t){if(!this.connectedWallet)throw new Error("No wallet connected");if(!this.connectedWallet.signTransaction)throw new Error("Wallet does not support signTransaction");let e=Jf.Buffer.from(t,"base64"),n=dt.from(e);return(await this.connectedWallet.signTransaction(n)).serialize().toString("base64")}};var Vi=new Hi;function op(){let r=Vi.wallets.map(t=>({name:t.name,icon:t.icon}));return JSON.stringify(r)}async function ap(r){let t=await Vi.signIn(r),e={address:t.account.address,signature:t.signature,message:t.signedMessage};return JSON.stringify(e)}function cp(){return Vi.connectedWallet}async function up(r){return Vi.signTransaction(r)}window.getWallets=op;window.signIn=ap;window.getConnectedWallet=cp;window.signTransaction=up;})();
